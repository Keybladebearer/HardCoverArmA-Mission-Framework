class USMC {
			...
			// United State Marine Corps (Woodland) Gear Script by Keyblade
			// Info:
			...
			#define smg "CUP_arifle_M4A1_black" 
			#define smgmag "CUP_30Rnd_556x45_Stanag"
			...
			//Uniform		
			#define default_uniform "MarPat_Camo", "MarPat_Camo_SS"
			#define crew_uniform "CUP_U_B_USMC_PilotOverall"
			
			//Headgear
			#define leader_headgear "MarPat_Boonie", "MarPat_Cap"
			#define default_headgear "CUP_H_USMC_HelmetWDL", "CUP_H_USMC_Goggles_HelmetWDL","CUP_H_USMC_Headset_HelmetWDL", "CUP_H_USMC_Headset_GoggleW_HelmetWDL"
			#define vcrew_headgear "CUP_H_USMC_Crew_Helmet"
			#define pilot_headgear "CUP_H_USMC_Helmet_Pilot"
			#define sniper_headgear "MarPat_Boonie" 
			
			//Backpack
			#define default_backpack "MarPat_Backpack_Kitbag"
			#define crew_backpack "MarPat_Backpack_Kitbag"
